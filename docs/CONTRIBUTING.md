...
3. Run the tests:
   ...
   cargo test
   ```
   The command reports 306 passed. A failure names the test. Fix it and repeat.
...
It reports 306 passed. CI runs this suite and no other.
...
2. Run the suite with the feature:
   ...
   ```
   The command reports 307 passed. Without usbmon the extra test prints a skip
   message and passes.
